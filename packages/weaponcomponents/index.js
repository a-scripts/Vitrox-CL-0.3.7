...
mp.Player.prototype.giveWeaponComponent = function(weaponHash, componentHash) {
    if (!Number.isInteger(weaponHash)) weaponHash = parseInt(weaponHash);
    if (!Number.isInteger(componentHash)) componentHash = parseInt(componentHash);
...
mp.events.add("giveWeaponComponent", (player, weaponHash, componentHash) => player.giveWeaponComponent(weaponHash, componentHash));
...
mp.events.add("removeWeaponComponent", (player, weaponHash, componentHash) => player.removeWeaponComponent(weaponHash, componentHash));
...
mp.events.add("removeAllWeaponComponents", (player, weaponHash) => player.removeAllWeaponComponents(weaponHash));
...
mp.events.add("resetAllWeaponComponents", (player) => player.resetAllWeaponComponents());
