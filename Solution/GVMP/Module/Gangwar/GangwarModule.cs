    ...
    class GangwarModule : GVMP.Module.Module<GangwarModule>
    {
        ...
        protected override bool OnLoad()
        {
            ...
            while (reader.Read())
            {
                ...
                c.SetData("MESSAGE", new Message("Benutze E um einen Gangwar zu starten.", "GANGWAR", "red", 3000));
        ...
        public void Gangwar(Client c, string selection)
        {
            try
            {
                ...
                {
                    dbPlayer.SendNotification("Es müssen mindestens 3 Personen aus der anderen Fraktion online sein.", 3000, "red", "GANGWAR");
                    return;
                }
                if (BlockedZones.Contains(gw))
                {
                    dbPlayer.SendNotification("Dieses Gebiet wurde bereits angegriffen.", 3000, "red", "GANGWAR");
                    return;
                }
                if (RunningGangwar != null)
                {
                    dbPlayer.SendNotification("Es läuft bereits ein Gangwar.", 3000, "red", "GANGWAR");
                    return;
                }
                if (gw.Faction.Id == 0)
                {
                    dbPlayer.SendNotification("Du hast das Gebiet eingenommen.", 3000, "red", "GANGWAR");
                    GWZones.Remove(gw);
                ...
                foreach (DbPlayer dbTarget in gw.Faction.GetFactionPlayers())
                {
                    ...
                    dbTarget.SendNotification($"Das Gebiet {gw.Name} wird von der Fraktion {gw.Attacker.Name} angegriffen.", 6000, "red", "GANGWAR");
                }
                foreach (DbPlayer dbTarget in gw.Attacker.GetFactionPlayers())
                {
                    if (dbTarget != null && dbTarget.IsValid(true))
                        dbTarget.SendNotification($"Deine Fraktion greift das Gebiet {gw.Name} an.", 5000, "red", "GANGWAR");
                }
                Notification.SendGlobalNotification($"Die Fraktion {gw.Attacker.Name} greift das Gebiet {gw.Name} von der Fraktion {gw.Faction.Name} an.", 8000, "red", Notification.icon.warn);
                ...
                NAPI.Marker.CreateMarker(4, gw.Flag1.Position.Add(new Vector3(0, 0, 1)), new Vector3(), new Vector3(), 1.0f, new Color(160,32,240), false, Convert.ToUInt32(FactionModule.GangwarDimension));
                ...
                NAPI.Marker.CreateMarker(4, gw.Flag2.Position.Add(new Vector3(0, 0, 1)), new Vector3(), new Vector3(), 1.0f, new Color(160,32,240), false, Convert.ToUInt32(FactionModule.GangwarDimension));
                ...
                NAPI.Marker.CreateMarker(4, gw.Flag3.Position.Add(new Vector3(0, 0, 1)), new Vector3(), new Vector3(), 1.0f, new Color(160,32,240), false, Convert.ToUInt32(FactionModule.GangwarDimension));
                ...
                NAPI.Marker.CreateMarker(4, gw.Flag4.Position.Add(new Vector3(0, 0, 1)), new Vector3(), new Vector3(), 1.0f, new Color(160,32,240), false, Convert.ToUInt32(FactionModule.GangwarDimension));
            }
            catch (Exception ex)
            {
        ...
        public void EnterGWZone(ColShape col, Client c)
        {
            try
            {
                ...
                else if (col.HasData("GANGWAR_FLAG"))
                {
                    ...
                    //dbPlayer.SendNotification(string.Concat("Du hast die Flagge ", data.ToString(), " betreten."), 3000, "red", "GANGWAR");
                    switch (data)
                    {
                        case 1:
                            {
        ...
        public void ExitGWZone(ColShape col, Client c)
        {
            try
            {
                ...
                {
                    int data = (int)((dynamic)col.GetData("GANGWAR_FLAG"));
                   // dbPlayer.SendNotification("Du hast die Flagge " + data + " verlassen.", 3000, "red", "GANGWAR");
            ...
            try
            {
                ...
                if (RunningGangwar.AttackerPoints > RunningGangwar.FactionPoints)
                {
                    ...
                    Notification.SendGlobalNotification(
                        ...
                        8000, "red", Notification.icon.warn);
