...
namespace GVMP
{
    class LaboratoryModule : GVMP.Module.Module<LaboratoryModule>
    {
		...
		protected override bool OnLoad()
		{
				...
				try
				{
					if ((reader).HasRows)
					{
						while ((reader).Read())
						{
							...
							NAPI.Marker.CreateMarker(1, laboratory.Entrance, new Vector3(), new Vector3(), 1f, new Color(160,32,240), false, 0u);
						}
					}
				}
				finally
			...
			NAPI.Marker.CreateMarker(1, LaboratorySetingsPoint, new Vector3(), new Vector3(), 1f, new Color(160,32,240), false, uint.MaxValue);
			NAPI.Marker.CreateMarker(1, EphiDustProcessingPoint, new Vector3(), new Vector3(), 1f, new Color(160,32,240), false, uint.MaxValue);
			NAPI.Marker.CreateMarker(1, LaboratoryInteriorPoint, new Vector3(), new Vector3(), 1f, new Color(160,32,240), false, uint.MaxValue);
			NAPI.Marker.CreateMarker(1, BatteryProcessingPoint, new Vector3(), new Vector3(), 1f, new Color(160,32,240), false, uint.MaxValue);
			NAPI.Marker.CreateMarker(1, MaterialStoragePoint, new Vector3(), new Vector3(), 1f, new Color(160,32,240), false, uint.MaxValue);
			NAPI.Marker.CreateMarker(1, MaterialProductsPoint, new Vector3(), new Vector3(), 1f, new Color(160,32,240), false, uint.MaxValue);
			return true;
		}
