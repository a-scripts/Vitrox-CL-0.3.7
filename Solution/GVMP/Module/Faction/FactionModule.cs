...
namespace GVMP
{
    class FactionModule : GVMP.Module.Module<FactionModule>
    {
        ...
        public static Vector3 StoragePosition = new Vector3(115.25, -741.9, 258.15);
...
new NativeItem("1x FastEquipBC - 210000$", "FastEquipBC-210000-1")
        ...
        public static void initializeFraktionen()
        {
            ...
            try
            {
                NAPI.Marker.CreateMarker(1, new Vector3(125.71, -742.96, 257.15), new Vector3(), new Vector3(), 1.0f, new Color(160,32,240));
                NAPI.Marker.CreateMarker(1, new Vector3(121.31, -737.58, 257.15), new Vector3(), new Vector3(), 1.0f, new Color(160,32,240));
                NAPI.Marker.CreateMarker(1, new Vector3(117.65, -749.16, 257.15), new Vector3(), new Vector3(), 1.0f, new Color(160,32,240));
                NAPI.Marker.CreateMarker(1, new Vector3(121.93, -750.34, 257.15), new Vector3(), new Vector3(), 1.0f, new Color(160,32,240));

                ColShape val3 = NAPI.ColShape.CreateCylinderColShape(new Vector3(121.31, -737.58, 258.15), 1.4f, 1.4f, uint.MaxValue);
                ...
                ColShape val4 = NAPI.ColShape.CreateCylinderColShape(new Vector3(125.71, -742.96, 258.15), 1.4f, 1.4f, uint.MaxValue);
                ...
                ColShape val2 = NAPI.ColShape.CreateCylinderColShape(new Vector3(117.65, -749.16, 258.15), 1.4f, 1.4f, uint.MaxValue);
                val2.SetData("FUNCTION_MODEL", new FunctionModel("enterGangwarDimension"));
                val2.SetData("MESSAGE", new Message("Benutze E um die Gangwar Dimension zu betreten / verlassen.", "GANGWAR", "red", 3000));

                ColShape val5 = NAPI.ColShape.CreateCylinderColShape(new Vector3(121.93, -750.34, 258.15), 1.4f, 1.4f, uint.MaxValue);
                val5.SetData("FUNCTION_MODEL", new FunctionModel("enterKriegsDimension"));
                val5.SetData("MESSAGE", new Message("Benutze E um die Kriegs Dimension zu betreten / verlassen.", "KRIEG", "red", 3000));
                ...
                foreach (Faction fraktion in factionList)
                {
                    ...
                    //if (fraktion.BadFraktion)
                    {
                        ...
                        NAPI.Marker.CreateMarker(1, fraktion.Garage, new Vector3(), new Vector3(), 1f, new Color(160,32,240));
...
new NativeItem("1x FastEquipBC - 210000$", "FastEquipBC-210000-1")
        ...
        public void enterGangwarDimension(Client c)
        {
            try
            {
                ...
                {
                    dbPlayer.SendNotification("Du hast die Gangwar Dimension betreten.", 3000, "red", "GANGWAR");
                    c.Dimension = Convert.ToUInt32(GangwarDimension);
                    c.Position = FactionModule.StoragePosition;
                }
                else
                {
                    dbPlayer.SendNotification("Du hast die Gangwar Dimension verlassen.", 3000, "red", "GANGWAR");
                    c.RemoveAllWeapons();
                    c.Dimension = 9999;
        ...
        public void enterKriegsDimension(Client c)
        {
            try
            {
                ...
                if (c.Dimension == dbPlayer.Faction.Dimension)
                {
                    dbPlayer.SendNotification("Du hast die Kriegs Dimension betreten.", 3000, "red", "KRIEG");
                    c.Dimension = Convert.ToUInt32(1338);
                }
                else
                {
                    dbPlayer.SendNotification("Du hast die Kriegs Dimension verlassen.", 3000, "red", "KRIEG");
                    c.Dimension = Convert.ToUInt32(dbPlayer.Faction.Dimension);
                }
            }
            catch (Exception ex)
