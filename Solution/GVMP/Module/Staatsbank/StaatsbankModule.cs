...
namespace GVMP.Module.Staatsbank
{
    class StaatsbankModule : GVMP.Module.Module<StaatsbankModule>
    {
        ...
        protected override bool OnLoad()
        {
            try
            {
                ...
                Marker mark = NAPI.Marker.CreateMarker(1, new Vector3(254, 225.27, 101.88 - 0.62), new Vector3(), new Vector3(), 1.0f, new Color(160,32,240), false, 0);
                mark.SetData("staatsmark", true);
                Marker markback = NAPI.Marker.CreateMarker(1, new Vector3(253.26, 223.13, 101.68 - 0.62), new Vector3(), new Vector3(), 1.0f, new Color(160,32,240), false, 0);
        ...
        public static void openstaatsbankschrank(Client player, int schrank)
        {
            try
            {
        ...
        public static void leavestaatsbank(Client player, int number, int number2)
        {
            try
            {
                DbPlayer dbPlayer = player.GetPlayer();
        ...
        public static void openstaatsbank(Client player)
        {
            try
            {
                DbPlayer dbPlayer = player.GetPlayer();
