...
namespace GVMP.Module.MAZ
{
    class MazModule : GVMP.Module.Module<MazModule>
    {
        ...
        public static void loadmaz(MySqlDataReader reader)
        {
            try
            {
                ...
                NAPI.Task.Run(() =>
                {
                    ...
                    val.SetData("MESSAGE", new Message("Benutze E um das MAZ aufzubrechen", "MAZ", "red", 5000));
                ...
                NAPI.Task.Run(() =>
                {
                    Marker mark = NAPI.Marker.CreateMarker(1, maz.Spawn, new Vector3(), new Vector3(), 1.0f, new Color(160,32,240), false, 0);
        ...
        [RemoteEvent("openmaz")]
        public void openmaz(Client c, int id, int mazid)
        {
            try
            {
                if (c == null) return;
                ...
                {
                    dbplayer.SendNotification("Du besitzt nicht das nötige Item um das MAZ zu öffnen", 3000, "red", "MAZ");
                    return;
                }
                ...
                NAPI.Task.Run(() =>
                {
                    ...
                    dbPlayer.SendNotification("Kiste erfolgreich geöffnet", 3000, "red", "MAZ");
