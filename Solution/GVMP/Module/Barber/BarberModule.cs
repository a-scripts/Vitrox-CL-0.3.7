                ...
                try
                {
                    if (reader.HasRows)
                    {
                        while (reader.Read())
                        {
                            ...
                            val.SetData("MESSAGE", new Message("Benutze E um dir die Haare schneiden zu lassen.", Name, "red", 3000));

                            NAPI.Marker.CreateMarker(1, Position, new Vector3(), new Vector3(), 1.0f, new Color(160,32,240), false, 0);
