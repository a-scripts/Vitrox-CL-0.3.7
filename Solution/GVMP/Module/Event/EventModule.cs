...
namespace GVMP
{
    class EventModule : GVMP.Module.Module<EventModule>
    {
        ...
        protected override bool OnLoad()
        {
            ...
            {
                Name = "",
                Position = new Vector3(390.17, -356.3, 48.02)
            });
            ...
            foreach (EventModel eventModel in equipList)
            {
                ...
                cb.SetData("MESSAGE", new Message("Benutze E um dein Geschenk zu abzuholen", "EVENT", "red", 3000));
                NAPI.Marker.CreateMarker(1, new Vector3(390.17, -356.3, 48.02), new Vector3(), new Vector3(), 1.4f, new Color(0, 0, 0), false, 0);
                // NAPI.Marker.CreateMarker(1, equippointModel.position, new Vector3(), new Vector3(), 7.0f, new Color(160,32,240), false, 0);
            }
            ...
            try
            {
                ...
                try
                {
                    ...
                    dbPlayer.UpdateInventoryItems("Geschenk", 1, false);
                        ...
                        dbPlayer.SendNotification("Du hast dir dein Geschenk abgeholt. Lass es dir nicht abziehen!" + dbPlayer.Event, 3000, "red","EVENT");
                    }
                }
                catch (Exception ex)
                {
