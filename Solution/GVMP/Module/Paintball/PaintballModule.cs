...
namespace GVMP
{
    class PaintballModule : GVMP.Module.Module<PaintballModule>
    {
        ...
        protected override bool OnLoad()
        {
            ...
            NAPI.Blip.CreateBlip(432, new Vector3(492.95, -742.82, 24.00), 1.0f, 0, "FFA", 255, 0, true, 0, 0);
            NAPI.Marker.CreateMarker(1, new Vector3(492.95, -742.82, 24.00), new Vector3(), new Vector3(), 1.0f, new Color(160, 32, 240), false, 0);

            ColShape cb = NAPI.ColShape.CreateCylinderColShape(new Vector3(492.95, -742.82, 24.00), 1.4f, 1.4f, 0);
            cb.SetData("FUNCTION_MODEL", new FunctionModel("FFA-Menu"));
            cb.SetData("MESSAGE", new Message("Benutze E um FFA zu spielen.", "PAINTBALL", "purple", 3000));
        ...
        public static void leavePaintball(Client c)
        {
            try
            {
                ...
                dbPlayer.ACWait();
                dbPlayer.SetPosition(new Vector3(492.95, -742.82, 24.00));
