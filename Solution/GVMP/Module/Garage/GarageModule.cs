    ...
    class GarageModule : GVMP.Module.Module<GarageModule>
    {
        ...
        public static void loadGarage(MySqlDataReader reader)
        {
            try
            {
                ...
                val.SetData("MESSAGE", new Message("Benutze E um die Garage zu öffnen.", garage.Name, "red", 5000));


                NAPI.Marker.CreateMarker(44, garage.Position, new Vector3(), new Vector3(), 1.0f, new Color(160,32,240), false, 0);
