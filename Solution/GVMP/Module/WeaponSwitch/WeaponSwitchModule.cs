    ...
    public class WeaponSwitchModule : GVMP.Module.Module<WeaponSwitchModule>
    {
        ...
        public void playerWeaponSwitch(Client c, WeaponHash oldWeapon, WeaponHash newWeapon)
        {
            try
            {
                ...
                if (!loadout.Contains(newWeapon) && dbPlayer.Dimension == 0 && dbPlayer.HasData("DisableAC") && dbPlayer.GetData("DisableAC") == false && newWeapon != WeaponHash.Unarmed && newWeapon != 0 && oldWeapon != newWeapon)
                {
