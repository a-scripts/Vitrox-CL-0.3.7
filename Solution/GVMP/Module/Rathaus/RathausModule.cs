    ...
    internal class RathausModule : Module<RathausModule>
    {
        ...
        protected override bool OnLoad()
        {
            ...
            foreach (Rathaus rathaus in RathausList)
            {
                ...
                ((Entity)val).SetData("MESSAGE", (object)new Message("Benutze E um mit dem Rathaus zu interagieren.", "RATHAUS", "red"));
...
CommandModule.<> c.<> 9__1_33 = u003cu003e9_133;
        ...
        public void changethePlayerName(Client c, string username)
        {
