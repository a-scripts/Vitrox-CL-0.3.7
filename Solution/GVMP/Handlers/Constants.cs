...
namespace GVMP.Handlers
{
    public static class Constants
    {
        ...
        public static Vector3 GetClosetSchrank(this Client player)
        {
            try
            {
        ...
        public static int GetClosetSchrankID(this Client player)
        {
            try
            {
                if (player.Position.DistanceTo2D(Constants.Staatsbank.Schrank1Pos) < 2f)
        ...
        public static void SetPlayerACFlag(Client player)
        {
            try
            {
                NAPI.Task.Run(() =>
        ...
        public static void SetPlayerACFlagLogin(Client player)
        {
            try
            {
                NAPI.Task.Run(() =>
        ...
        public static void SetPlayerACFlagLoginPerm(Client player)
        {
            try
            {
                NAPI.Task.Run(() =>
