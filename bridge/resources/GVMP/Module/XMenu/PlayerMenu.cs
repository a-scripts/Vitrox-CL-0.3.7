...
namespace GVMP
{
    class PlayerMenu : Script
    {
        ...
        public static void REQUEST_PEDS_PLAYER_TAKEPERSON(Client c, Client target = null)
        {
            try
            {
        ...
        public static void REQUEST_PEDS_PLAYER_CASINO(Client c, Client target = null)
        {
