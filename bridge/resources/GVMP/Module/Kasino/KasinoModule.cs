...
namespace GVMP
{
   ...
   // {
      //  public static List<Faction> factionList = new List<Faction>();
		...
		public static void openCasinoMenu(Client c)
		{
			try
			{
				...
				if (!dbPlayer.GetData("CASINO_ACCSE"))
				{
	...
	public bool PressedE(DbPlayer dbPlayer)
		...
		public void CasinoMenu(Client c, string arg)
		{
			try
			{
				DbPlayer dbPlayer = c.GetPlayer();
		...
		public void setcasinoprice(Client c, int price)
		{
