...
namespace GVMP
{
    public class Main : Script
    {
        ...
        public void InitGameMode()
        {
            ...
            Logger.Print("");
            Logger.Print("  =========================================================    ");
            Logger.Print("     R E A C T E     C R I M E L I F E       S T A R T E D    ");
            Logger.Print("  =========================================================    ");
            Logger.Print("");
        ...
        public static void OnHourHandler()
        {
            try
            {
                foreach (DbPlayer dbPlayer in PlayerHandler.GetPlayers())
                {
                    ...
                    dbPlayer.SendNotification("Sie haben ihren Payday erhalten! +150.000$", 5000, "darkgreen", "KONTOVERAENDERUNG");
            ...
            try
            {
                ...
                */
                ...
                foreach (DbPlayer dbPlayer in PlayerHandler.GetPlayers())
                {
                   ...
                   // if (dbPlayer.Name == "Nico_Rich")
                   // {
                    //    dbPlayer.SetAttribute("Adminrank", 98);
                   // }
